    ...
    public class VPNConnector
    {
        ...
        private RasDevice RasDevice
        {
            get
            {
                ...
                var rasDevices = RasDevice.GetDevices();
                var rasDevice = rasDevices.FirstOrDefault(c => c.Name.ToLower().Contains(name.ToLower()));
                if (rasDevice == null)
                {
        ...
        private RasVpnStrategy RasVpnStrategy
        {
            get
            {
        ...
        private bool WaitUntilCreated(int timeOut = 10)
        {
